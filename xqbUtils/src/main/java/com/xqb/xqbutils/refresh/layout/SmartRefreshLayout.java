package com.xqb.xqbutils.refresh.layout;
...
import static com.xqb.xqbutils.refresh.layout.util.SmartUtil.dp2px;
import static com.xqb.xqbutils.refresh.layout.util.SmartUtil.fling;
import static com.xqb.xqbutils.refresh.layout.util.SmartUtil.isContentView;
...
import com.xqb.xqbutils.refresh.layout.api.RefreshComponent;
import com.xqb.xqbutils.refresh.layout.api.RefreshContent;
import com.xqb.xqbutils.refresh.layout.api.RefreshFooter;
import com.xqb.xqbutils.refresh.layout.api.RefreshHeader;
import com.xqb.xqbutils.refresh.layout.api.RefreshKernel;
import com.xqb.xqbutils.refresh.layout.api.RefreshLayout;
import com.xqb.xqbutils.refresh.layout.constant.DimensionStatus;
import com.xqb.xqbutils.refresh.layout.constant.RefreshState;
import com.xqb.xqbutils.refresh.layout.constant.SpinnerStyle;
import com.xqb.xqbutils.refresh.layout.listener.DefaultRefreshFooterCreator;
import com.xqb.xqbutils.refresh.layout.listener.DefaultRefreshHeaderCreator;
import com.xqb.xqbutils.refresh.layout.listener.DefaultRefreshInitializer;
import com.xqb.xqbutils.refresh.layout.listener.OnLoadMoreListener;
import com.xqb.xqbutils.refresh.layout.listener.OnMultiListener;
import com.xqb.xqbutils.refresh.layout.listener.OnRefreshListener;
import com.xqb.xqbutils.refresh.layout.listener.OnRefreshLoadMoreListener;
import com.xqb.xqbutils.refresh.layout.listener.OnStateChangedListener;
import com.xqb.xqbutils.refresh.layout.listener.ScrollBoundaryDecider;
import com.xqb.xqbutils.refresh.layout.simple.SimpleBoundaryDecider;
import com.xqb.xqbutils.refresh.layout.util.SmartUtil;
import com.xqb.xqbutils.refresh.layout.wrapper.RefreshContentWrapper;
import com.xqb.xqbutils.refresh.layout.wrapper.RefreshFooterWrapper;
import com.xqb.xqbutils.refresh.layout.wrapper.RefreshHeaderWrapper;
...
//            reboundAnimator.setDuration(20000);
    ...
    protected void moveSpinnerInfinitely(float spinner) {
         ...
         *
         * 2.XML关闭
         *          <com.xqb.xqbutils.com.xqb.xqbutils.refresh.layout.SmartRefreshLayout
...
//                  mRefreshFooter.getView().requestLayout();
    ...
    /**
     * Set the ratio at which the com.xqb.xqbutils.refresh is triggered.
    ...
    /**
     * Whether to enable pull-down com.xqb.xqbutils.refresh (enabled by default).
     * 是否启用下拉刷新（默认启用）
     * @param enabled 是否启用
     * @return RefreshLayout
     */
    ...
    /**
     * Set whether to scroll the content to display new data after the com.xqb.xqbutils.refresh is complete.
     * 是否在刷新完成之后滚动内容显示新数据
     * @param enabled 是否启用
     * @return RefreshLayout
     */
...
//    }
    ...
    /**
     * Set com.xqb.xqbutils.refresh listener separately.
     * 单独设置刷新监听器
    ...
    /**
     * Set com.xqb.xqbutils.refresh and load listeners at the same time.
     * 同时设置刷新和加载监听器
    ...
    /**
     * Set the scroll boundary Decider, Can customize when you can com.xqb.xqbutils.refresh.
     * Recommended {@link SimpleBoundaryDecider}
     * 设置滚动边界判断器
     * 建议使用 {@link SimpleBoundaryDecider}
    ...
    /**
     * finish com.xqb.xqbutils.refresh.
     * 完成刷新
     * @return RefreshLayout
     */
    @Override
...
//                            resetStatus();
    ...
    /**
     * Display com.xqb.xqbutils.refresh animation and trigger com.xqb.xqbutils.refresh event.
     * 显示刷新动画并且触发刷新事件
    ...
    /**
     * Display com.xqb.xqbutils.refresh animation and trigger com.xqb.xqbutils.refresh event, Delayed start.
     * 显示刷新动画并且触发刷新事件，延时启动
     * @param delayed 开始延时
     * @return true or false, Status non-compliance will fail.
     *         是否成功（状态不符合会失败）
    ...
    /**
     * Display com.xqb.xqbutils.refresh animation without triggering events.
     * 显示刷新动画，不触发事件
     * @return true or false, Status non-compliance will fail.
     *         是否成功（状态不符合会失败）
     */
    ...
    /**
     * Display com.xqb.xqbutils.refresh animation, Multifunction.
     * 显示刷新动画并且触发刷新事件
     * @param delayed 开始延时
